...
import { MaterialCommunityIcons, SimpleLineIcons, Feather, FontAwesome, EvilIcons } from '@expo/vector-icons';
...
const CDAProjectReport = ({ navigation }) => {
    const [community, onChangeCommunity] = useState('');
    const [cda, onChangeCda] = useState('');
    const [pStatus, onChangePstatus] = useState('');
    const [pDetails, onChangePdetails] = useState('');
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scrollContainer}>
                <View style={styles.textContainer}>
                    <Text style={styles.mainText}>Make a Report</Text>
                    <Text style={styles.additionalText}>Report any breach or give un update on the status of the CDA projects in your community.</Text>
                </View>
                ...
                <View style={styles.inputContainer}>
                    <Text style={styles.labelText}>CDA Project</Text>
                    <TextInputComponent
                        iconType='image-icon'
                        iconName="project-icon"
                        placeholder='e.g Youth Empower'
                        placeholderTextColor='#cccc'
                        value={cda}
                        onChangeText={onChangeCda}
                        keyboardType='default'
                        autoCapitalize="sentences"
                        secureTextEntry={false}
                        style={[styles.inputField, { textAlign: 'left' }]}
                ...
                <View style={styles.inputContainer}>
                    ...
                    <View style={styles.pickerContainer}>
                        <Image
                            source={require('../../assets/images/projectIcon.png')}
                            style={styles.imgIcon}
                        />
                        <Picker
                            selectedValue={pStatus}
                            onValueChange={(itemValue, itemIndex) => onChangePstatus(itemValue)}
                            style={styles.picker}
                        >
                            <Picker.Item label="Select" value="Select" style={projectStatus === "Select" ? styles.defaultPickerLabelStyle : styles.pickerLabel} />
                ...
                <Text style={[styles.labelText, { marginLeft: 10, }]}>Photos of Project (Optional) </Text>
...
export default CDAProjectReport;
